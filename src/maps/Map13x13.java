...
public class Map13x13 extends JFrame {
    ...
    private int remainingPoints = 96;
    ...
    public Map13x13() {
        ...
        //GHOSTS INICIALIZATION
        ghosts = new Ghost[3];

        ghosts[0] = new Ghost(11, 11, Ghost.GhostColor.BLUE, map, MAP_WIDTH, MAP_HEIGHT, TILE_SIZE, grid);
        ghosts[0].scaleIcons(50, 50);

        ghosts[1] = new Ghost(5, 5, Ghost.GhostColor.PINK, map, MAP_WIDTH, MAP_HEIGHT, TILE_SIZE, grid);
        ghosts[1].scaleIcons(50, 50);

        ghosts[2] = new Ghost(9, 9, Ghost.GhostColor.GREEN, map, MAP_WIDTH, MAP_HEIGHT, TILE_SIZE, grid);
        ghosts[2].scaleIcons(50, 50);
        ...
        // PACMAN INICIALIZATION AND SETINGS
        ...
        addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                if (e.getKeyCode() == KeyEvent.VK_ESCAPE) {
                    int choice = JOptionPane.showConfirmDialog(Map13x13.this, "Czy na pewno chcesz zamknąć grę?", "Potwierdzenie zamknięcia", JOptionPane.YES_NO_OPTION);
